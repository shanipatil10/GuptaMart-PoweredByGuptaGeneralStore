...
export default function CartItem({ item }) {
  ...
  return (
    <article
      className={`grid grid-cols-[80px_1fr_auto] gap-4 border-b border-[#1c6d24]/10 py-5 transition-all duration-250 sm:grid-cols-[96px_1fr_auto] ${
        isRemoving
    ...
    >
      ...
      <div className="flex min-w-[70px] flex-col items-end justify-between">
        <p className="text-sm font-semibold text-[#1a1c19] sm:text-base">
          ₹{itemTotal}
        </p>
